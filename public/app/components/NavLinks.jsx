...
import { faHome, faBook, faTachometerAlt, faUser, faSignInAlt, faUserPlus, faUsersCog, } from "@fortawesome/free-solid-svg-icons";
export default function NavLinks({ isSignedIn, onLinkClick }) {
    return (<div className="flex items-center space-x-6">
      {/* // {/* Admin Panel Link  */}
      {isSignedIn && (<Link href="/admin/users" className="flex flex-col items-center text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition duration-300" onClick={onLinkClick}>
          <FontAwesomeIcon icon={faUsersCog} className="w-6 h-6"/>
          <span className="text-xs mt-1">Admin</span>
        </Link>)}

      {/* // {/* Home Link  */}
      <Link href="/" className="flex flex-col items-center text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition duration-300" onClick={onLinkClick}>
        <FontAwesomeIcon icon={faHome} className="w-6 h-6"/>
        <span className="text-xs mt-1">Home</span>
      </Link>

      {/* // {/* Content Link  */}
      <Link href="/content-show" className="flex flex-col items-center text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition duration-300" onClick={onLinkClick}>
      ...
      {isSignedIn && (<>
          ...
          <Link href="/dashboard" className="flex flex-col items-center text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition duration-300" onClick={onLinkClick}>
            <FontAwesomeIcon icon={faTachometerAlt} className="w-6 h-6"/>
            <span className="text-xs mt-1">Dashboard</span>
          </Link>

          {/* // {/* Profile Link  */}
          <Link href="/profile" className="flex flex-col items-center text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition duration-300" onClick={onLinkClick}>
            <FontAwesomeIcon icon={faUser} className="w-6 h-6"/>
            <span className="text-xs mt-1">Profile</span>
          </Link>
          <Link href="/settings-onboarding" className="flex flex-col items-center text-gray-600 hover:text-gray-800 transition duration-300" onClick={onLinkClick}>
             <FontAwesomeIcon icon={faUser} className="w-6 h-6"/>
      ...
      {!isSignedIn && (<>
          {/* // {/* Sign In Link  */}
          <Link href="/signin-form" className="flex flex-col items-center text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition duration-300" onClick={onLinkClick}>
            <FontAwesomeIcon icon={faSignInAlt} className="w-6 h-6"/>
            <span className="text-xs mt-1">Sign In</span>
          </Link>

          {/* // {/* Sign Up Link  */}
          <Link href="/signup-form" className="flex flex-col items-center text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition duration-300" onClick={onLinkClick}>
