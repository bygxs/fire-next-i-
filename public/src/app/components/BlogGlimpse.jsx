...
export default function BlogGlimpse() {
    ...
    return latestContent ? (<div className="w-full max-w-md mb-8 mt-4" style={{ height: fixedHeight }}>
      <Link href="/content-show">
        <div className="bg-white dark:bg-gray-800 p-4 rounded shadow h-full flex flex-col">
          ...
          {latestContent.photoUrl && (<img src={latestContent.photoUrl} alt={latestContent.title} className="mt-2 w-full object-cover rounded border-2 border-gray-300 dark:border-gray-700" style={{ height: "200px" }}/>)}
        </div>
      </Link>
