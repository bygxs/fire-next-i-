...
export default function Onboarding() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const profileData = Object.assign(Object.assign({}, formData), { interests: formData.interests
                    .split(",")
                    .map((interest) => interest.trim()), socialLinks: formData.socialLinks, profilePictureUrl, email: user.email, createdAt: new Date().toISOString() });
