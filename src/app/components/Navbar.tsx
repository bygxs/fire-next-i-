          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {isSignedIn && (
              <button
                ...
                className="text-xs px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition duration-300 dark:bg-red-600 dark:hover:bg-red-700 text-sm font-medium"
              >
                Sign Out
              </button>
            )}
